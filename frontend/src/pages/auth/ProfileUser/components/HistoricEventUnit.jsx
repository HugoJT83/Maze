...
const HistoricEventUnit = ({ event }) => {
    ...
    return (
        <div className="bg-white-to-black m-4 p-6 w-full lg:w-3/4 flex flex-col md:flex-row gap-6 rounded-2xl justify-between shadow-md border border-gray-to-yellow/10 hover:scale-[1.02] hover:shadow-xl transition-all duration-300">
            {/* Left Block: Info */}
            <div className="flex-1 flex flex-col gap-3">
                <div className="flex items-center gap-3">
                    <h2 className="text-2xl font-bold text-indigo-to-yellow font-Bitcount">"{title}"</h2>
            ...
            <div className="flex flex-col justify-center items-start md:items-end min-w-[200px] border-t md:border-t-0 md:border-l border-gray-to-yellow/10 pt-4 md:pt-0 md:pl-6 gap-4">
                <div className="bg-lightgray-to-black p-4 rounded-xl border border-gray-to-yellow/10 w-full text-center md:text-right">
                    <span className="text-xs text-gray-to-yellow uppercase font-semibold tracking-wider block mb-1">
                        Tipo de evento
                    </span>
                    <span className="text-lg font-bold font-Bitcount text-indigo-to-yellow">
                        {isPaidEvent ? `Pago (${parseFloat(ticket_price).toFixed(2)} €)` : "Gratuito"}
                    </span>
                </div>

                <div className="bg-lightgray-to-black p-4 rounded-xl border border-gray-to-yellow/10 w-full text-center md:text-right flex items-center justify-between md:justify-end gap-3">
                    <div className="text-left md:text-right">
                        ...
                        <span className="text-2xl font-bold font-Bitcount text-indigo-to-yellow">
